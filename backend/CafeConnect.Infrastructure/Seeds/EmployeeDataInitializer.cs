...
namespace CafeConnect.Infrastructure.Seeds
{
    public class EmployeeDataInitializer
    {
        ...
        [
            ...
            new Employee { Id = GenerateEmployeeId(), Name = "Bob Johnson", EmailAddress = "bob.johnson@example.com", PhoneNumber = 94429350, Gender = Domain.Enums.GenderType.Male },
            new Employee { Id = GenerateEmployeeId(), Name = "Charlie Brown", EmailAddress = "charlie.brown@example.com", PhoneNumber = 91062378, Gender = Domain.Enums.GenderType.Male },
            new Employee { Id = GenerateEmployeeId(), Name = "Diana Prince", EmailAddress = "diana.prince@example.com", PhoneNumber = 97668551, Gender = Domain.Enums.GenderType.Female },
            new Employee { Id = GenerateEmployeeId(), Name = "Edward Davis", EmailAddress = "edward.davis@example.com", PhoneNumber = 93993258, Gender = Domain.Enums.GenderType.Male },
            new Employee { Id = GenerateEmployeeId(), Name = "Fiona Green", EmailAddress = "fiona.green@example.com", PhoneNumber = 9137758, Gender = Domain.Enums.GenderType.Female },
            ...
            new Employee { Id = GenerateEmployeeId(), Name = "Hannah Lee", EmailAddress = "hannah.lee@example.com", PhoneNumber = 94939717, Gender = Domain.Enums.GenderType.Female },
            ...
            new Employee { Id = GenerateEmployeeId(), Name = "Julia Adams", EmailAddress = "julia.adams@example.com", PhoneNumber = 87361383, Gender = Domain.Enums.GenderType.Female },
            ...
            new Employee { Id = GenerateEmployeeId(), Name = "Pamela Anderson", EmailAddress = "pamela.anderson@example.com", PhoneNumber = 99498058, Gender = Domain.Enums.GenderType.Female },
