...
namespace CafeConnect.Infrastructure.Seeds
{
    public class EmployeeDataInitializer
    {
        ...
        [
            ...
            new Employee { Id = GenerateEmployeeId(), Name = "Mike Scott", EmailAddress = "mike.scott@example.com", PhoneNumber = 47145172, Gender = Domain.Enums.GenderType.Male },
            new Employee { Id = GenerateEmployeeId(), Name = "Nina Patel", EmailAddress = "nina.patel@example.com", PhoneNumber = 07361383, Gender = Domain.Enums.GenderType.Female },
            ...
            new Employee { Id = GenerateEmployeeId(), Name = "Rachel Green", EmailAddress = "rachel.green@example.com", PhoneNumber = 27542242, Gender = Domain.Enums.GenderType.Female },
            new Employee { Id = GenerateEmployeeId(), Name = "Sam Wilson", EmailAddress = "sam.wilson@example.com", PhoneNumber = 15980281, Gender = Domain.Enums.GenderType.Male },
            ...
            new Employee { Id = GenerateEmployeeId(), Name = "Ursula Grant", EmailAddress = "ursula.grant@example.com", PhoneNumber = 47145172, Gender = Domain.Enums.GenderType.Female },
            new Employee { Id = GenerateEmployeeId(), Name = "Victor Lee", EmailAddress = "victor.lee@example.com", PhoneNumber = 15980281, Gender = Domain.Enums.GenderType.Male },
            new Employee { Id = GenerateEmployeeId(), Name = "Wendy Hill", EmailAddress = "wendy.hill@example.com", PhoneNumber = 36366852, Gender = Domain.Enums.GenderType.Female },
            new Employee { Id = GenerateEmployeeId(), Name = "Xander Cole", EmailAddress = "xander.cole@example.com", PhoneNumber = 07361383, Gender = Domain.Enums.GenderType.Male },
            ...
            new Employee { Id = GenerateEmployeeId(), Name = "Ben Lewis", EmailAddress = "ben.lewis@example.com", PhoneNumber = 55745072, Gender = Domain.Enums.GenderType.Male },
            new Employee { Id = GenerateEmployeeId(), Name = "Clara Scott", EmailAddress = "clara.scott@example.com", PhoneNumber = 91353642, Gender = Domain.Enums.GenderType.Female },
            new Employee { Id = GenerateEmployeeId(), Name = "David King", EmailAddress = "david.king@example.com", PhoneNumber = 15980281, Gender = Domain.Enums.GenderType.Male}
        ];
